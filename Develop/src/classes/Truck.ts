...
class Truck extends Vehicle implements AbleToTow {
  ...
  // I have declared the properties of the Truck class in the Vehicle class except for the towingCapacity property
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    const vehicleMakeModel = vehicle ? `${vehicle.make} ${vehicle.model}` : 'Vehicle';
